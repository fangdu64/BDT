...
if 'ReplicaGroupDescriptor' not in _M_IceGrid.__dict__:
    ...
    class ReplicaGroupDescriptor(object):
        ...
        def __init__(self, id='', loadBalancing=None, proxyOptions='', objects=None, description=''):
            self.id = id
...
Ice.sliceChecksums["::IceGrid::ReplicaGroupDescriptor"] = "87acc1bd322ee928e2d23d5d179c9afc"
