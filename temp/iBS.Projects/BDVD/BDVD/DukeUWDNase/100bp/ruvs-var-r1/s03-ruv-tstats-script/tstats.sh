#qsub -m e -M fdu1@jhmi.edu -cwd -pe local 42 -l hongkai,mem_free=2G,h_vmem=200G tstats.sh
...
designFile="${projectDir}/s03-ruv-tstats-script/bdvdRuvTstatsDesign.py"
