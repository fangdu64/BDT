...
Usage:
    fcdc-debug [options] <--fcdc-dir fcdc-dir> <design-file>
...
class BDVDParams:
    ...
    def parse_options(self, argv):
        ...
        if self.fcdc_dir is not None:
            fcdcentral_dir = self.fcdc_dir+"/fcdcentral/"
...
def main(argv=None):
    ...
    try:
        ...
        bdvd_logp()
        bdvd_log("Beginning fcdc debug run (v"+iBSUtil.get_version()+")")
        bdvd_logp("-----------------------------------------------")
