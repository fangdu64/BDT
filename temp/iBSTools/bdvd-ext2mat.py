...
def prepare_output_dir():
    ...
    shutil.copy(gParams.design_file,"{0}/bdvdExt2MatDesign.py".format(script_dir))
...
def uploadData(fcdcPrx):
    ...
    import bdvdExt2MatDesign as design
...
def main(argv=None):
    ...
    try:
        ...
        bdvd_logp()
        bdvd_log("Beginning BDT Ext2Mat run (v"+iBSUtil.get_version()+")")
        bdvd_logp("-----------------------------------------------")
