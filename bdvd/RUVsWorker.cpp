...
CRUVsWorker::CRUVsWorker(int workerIdx, ::Ice::Long batchValueCnt, int m, int n, int permutationCnt, const iBS::IntVecVec& groupedCtrlSampleIdxs)
    ...
    m_colIdxPermutation(m_mt19937, groupedCtrlSampleIdxs)
{
    if (permutationCnt > 0)
    {
